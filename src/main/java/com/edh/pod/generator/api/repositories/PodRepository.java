...
public interface PodRepository extends JpaRepository<Pod, Integer>{
    ...
    @Query(value = "insert into pods(owner, member, member_email, spell_table_url, name) values (:owner, :member, :member_email, :spell_table_url, :name)", nativeQuery = true)
    void addPodMember(@Param("owner") String owner, @Param("member") String member, @Param("member_email") String member_email, @Param("spell_table_url") String spell_table_url, @Param("name") String name);
